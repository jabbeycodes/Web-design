  ...
  return (
    <main className="relative min-h-screen overflow-x-hidden" style={{ background: "var(--bg)", color: "var(--text)" }}>
      ...
      <div className="fixed inset-0 z-0 pointer-events-none">
        <div className="absolute top-0 left-1/4 w-[600px] h-[600px] rounded-full opacity-20" style={{ background: "radial-gradient(circle, rgba(245,158,11,0.3), transparent 70%)", filter: "blur(100px)" }} />
        <div className="absolute bottom-0 right-1/4 w-[500px] h-[500px] rounded-full opacity-15" style={{ background: "radial-gradient(circle, rgba(6,182,212,0.2), transparent 70%)", filter: "blur(100px)" }} />
      </div>
        ...
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8">
            {["Work", "Process", "Pricing", "About"].map((item) => (
              <a key={item} href={`#${item.toLowerCase()}`} className="text-sm font-medium transition-colors hover:text-white" style={{ color: "var(--text-muted)" }}>
                {item}
              </a>
            ))}
          </div>
          <div className="flex items-center gap-3">
            ...
            <motion.a
              href="#contact"
              className="px-5 py-2.5 rounded-full text-sm font-semibold bg-amber-500 text-black"
      ...
      <section className="relative z-10 min-h-screen flex flex-col justify-center px-6 pt-32 pb-20 max-w-6xl mx-auto">
        ...
        >
          <motion.p variants={fadeInUp} className="text-amber-500 text-sm font-semibold tracking-widest uppercase mb-6">
          ...
          >
            ...
            >
              ...
              <svg width="16" height="16" viewBox="0 0 16 16" fill="none"><path d="M3 8h10M9 4l4 4-4 4" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/></svg>
            </motion.a>
      ...
      <section id="work" className="relative z-10 px-6 py-24 max-w-6xl mx-auto">
        ...
        >
          {[
            { icon: "💻", title: "Your website looks outdated", desc: "First impressions matter. An old, slow site costs you credibility.", solution: "Modern, fast-loading sites that communicate quality." },
            { icon: "📉", title: "Visitors leave without action", desc: "Confusing navigation and weak CTAs kill conversions.", solution: "Strategic design with clear conversion paths." },
            { icon: "⏰", title: "Projects drag for months", desc: "Agencies that over-promise waste your time and budget.", solution: "Fixed timelines with weekly deliverables." },
            { icon: "🔧", title: "Can't update your own site", desc: "Paying for every tiny change is expensive.", solution: "Modern stacks you own. We train your team." },
          ].map((item, i) => (
            ...
            >
              ...
              <div className="rounded-lg px-3 py-2 text-sm" style={{ background: "rgba(245,158,11,0.1)", color: "var(--amber)" }}>
                ✓ {item.solution}
              </div>
            </motion.div>
          ))}
      ...
      <section className="relative z-10 px-6 py-24 max-w-6xl mx-auto">
        ...
        >
          {[
            { icon: "🎯", title: "Landing Pages", desc: "High-converting single-page sites that turn visitors into leads." },
            { icon: "📱", title: "Marketing Sites", desc: "Multi-page experiences with blogs, case studies, and SEO." },
            { icon: "🚀", title: "SaaS MVPs", desc: "Full-stack apps with auth, databases, payments, and dashboards." },
            { icon: "🛒", title: "E-commerce", desc: "Scalable online stores with cart, checkout, and inventory." },
            { icon: "🎨", title: "Brand Design", desc: "Visual identity, logo, and design systems." },
      ...
      <section id="process" className="relative z-10 px-6 py-24 max-w-6xl mx-auto">
        ...
        >
          {[
            { num: "01", title: "Discovery", desc: "Scope project, define metrics, create roadmap." },
            { num: "02", title: "Design", desc: "Figma prototypes. You see it before we build." },
            { num: "03", title: "Build", desc: "Next.js + Supabase. Weekly demos." },
            { num: "04", title: "Launch", desc: "Vercel deploy. You own the code." },
          ].map((step, i) => (
      ...
      <section className="relative z-10 px-6 py-24 max-w-6xl mx-auto">
        ...
        >
          {[
            ...
            { title: "The ShowMe Blog", tags: ["Next.js", "AI Content", "SEO"], desc: "Africa's #1 AI/Business/Tech platform with 4+ daily posts." },
            { title: "Jirapa Executive Realty", tags: ["Next.js", "Gallery", "JWT Auth"], desc: "Real estate showcase with 100+ property photos." },
            ...
            >
              <div className="aspect-video relative flex items-center justify-center text-4xl" style={{ background: "linear-gradient(135deg, var(--surface), var(--surface-2))" }}>
                📱
              </div>
              <div className="p-5">
      ...
      <footer className="relative z-10 border-t border-white/[0.06] px-6 py-10">
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-8 text-sm" style={{ color: "var(--text-muted)" }}>
            ...
            <a href="mailto:info@shwme.app" className="hover:text-white transition-colors">info@shwme.app</a>
          </div>
